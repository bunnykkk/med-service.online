...
const DoctorsPage = () => {
  ...
  for (let i = 0; i < 21; i++) {
    if (i == 0) {
      ...
      workDay.push({
        monthDay: date.toLocaleString("ru", Month),
        weekday: date.toLocaleString("ru", WeekDey),
      });
    } else {
    ...
    <>
      ...
      <div>
        <Dialog
          ...
          <DialogTitle id="alert-dialog-title">Направление</DialogTitle>
          <DialogContent>
                ...
                {product.map(e => {
                  return (
                    <Box
                      ...
                      <button className={"product"}>{e}</button>
                    </Box>
                  );
                })}
              </Grid>
              ...
              <Grid container>
                ...
                <Grid
                  ...
                  <Grid container xs={12}>
                    ...
                    <Grid xs={2}>-</Grid>
                    <Grid xs={2}>-</Grid>
                    <Grid xs={2}>15:30</Grid>
                    <Grid xs={2}>16:00</Grid>
                  </Grid>
                  <Grid container xs={12}>
                    <Grid ml={4} xs={2}>
                      -
                    </Grid>
                    <Grid xs={2}>17:00</Grid>
                    <Grid xs={2}>-</Grid>
                    <Grid xs={2}>17:00</Grid>
                    <Grid xs={2}>17:00</Grid>
                  </Grid>
