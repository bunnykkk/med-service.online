...
const images = [
  {
    ...
    title: '"Талантбекова Айдай - замечательный доктор! Объяснит, покажет и лишнего не назначит. Всем советую."',
    imgPath:
        ...
        <Grid mt={5} container justifyContent={'center'} color={'white'} xs={6}>
          <Grid mt={5} xs={5}>
            <Grid ml={5}>
              ...
              <Typography mt={1} width={185} variant={'body2'}>
                Вы мжете посмотреть наши
                отзывы в таких сервисах
                как “Яндекс” и “ Гугл”
              </Typography>
            </Grid>
            ...
            <Grid mt={1} ml={3}>
              ...
              <Rating sx={{marginLeft: 7}} name="read-only" size="small" value={5} readOnly/>
            </Grid>
          </Grid>
        </Grid>
        <Grid mt={5} container justifyContent={'center'} color={'white'} xs={6}>
