...
const ProductDetails = () => {
  ...
  return (
    <Grid mt={5} container spacing={5}>
      ...
      <Grid container mt={5} ml={8} display={"flex"} justifyContent={"center"}>
        <Grid xs={3}>
          <Card sx={{ maxWidth: 300 }}>
            <CardMedia component="img" height="250" image={doctorImg} />
            <br />
        ...
        <Grid xs={3}>
          <Card sx={{ maxWidth: 310 }}>
            <CardMedia component="img" height="250" image={smilingImg} />
            <br />
            <div style={{ textAlign: "center" }}>
              <Typography
                fontFamily={"Roboto"}
        ...
        <Grid xs={3}>
          <Card sx={{ maxWidth: 300 }}>
            <CardMedia component="img" height="250" image={prettyImg} />
            <br />
            <div style={{ textAlign: "center" }}>
              <Typography
                fontFamily={"Roboto"}
